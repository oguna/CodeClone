...
public class CommonCloneViewer {
	public void commonClone(CompareParser cParser){
		LinkedList<Clone> dcommonClones = new LinkedList<Clone>();
		LinkedList<Clone> ccommonClones = new LinkedList<Clone>();
		dcommonClones = cParser.getDcommon();
		ccommonClones = cParser.getCcommon();
		...
		try {
			File file = new File("C:/cygwin64/home/y-yusuke/simian/bin/Result/HTML/common.html");
			...
			tmp = dcommonClones.get(0).getId();
			for(int i=0 ; i < dcommonClones.size() ; i++){
				dclone = dcommonClones.get(i);
				cclone = ccommonClones.get(i);
				if(tmp == dclone.getId()){
					//index.html配色
	...
	public void generate(PrintWriter pw,int tmp ,int count,Clone dclone,Clone cclone){
		...
		try {
			...
			pw.print("		<td><a href=" + "data/common/" + tmp + "-" + count + "(origin).html#label>");
			pw.println(dclone.getFilename() +"</a></td>");
			pw.print("		<td><a href=" + "data/common/" + tmp + "-" + count + "(decompile).html#label>");
			pw.println(cclone.getFilename() +"</a></td>");
			pw.print("		<td><a href=" + "data/common/" + tmp + "-" + count + ".html>");
			 ...
			 */
			File file2 = new File("C:/cygwin64/home/y-yusuke/simian/bin/Result/HTML/data/common/" + tmp + "-" + count + "(decompile).html");
			 ...
			 */
			File file3 = new File("C:/cygwin64/home/y-yusuke/simian/bin/Result/HTML/data/common/" + tmp + "-" + count + "(origin).html");
			 ...
			 * 比較用html生成
			 */
			File file4 = new File("C:/cygwin64/home/y-yusuke/simian/bin/Result/HTML/data/common/" + tmp + "-" + count + ".html");
